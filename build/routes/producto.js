...
router.post('/agregar', fields_1.FieldsValidation_ProductosNuevo, fields_1.checkResult, async (req, res) => {
    try {
...
router.put('/:id', fields_1.FieldsValidation_Productos, fields_1.checkResult, async (req, res) => {
    const { id } = req.params;
    try {
