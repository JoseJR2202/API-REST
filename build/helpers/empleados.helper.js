...
exports.getEmpleados = async () => {
    ...
    try {
        const response = (await client.query(querys_1.querysEmpleados.GET_empleados)).rows;
...
exports.updateEmpleados = async ({ emple, ide }) => {
    ...
    try {
        ...
        const response = (await client.query(querys_1.querysEmpleados.UPDATE_empleados, [nombre, correo, telefono, ide])).rows[0];
        const empleados = {
            id: response.id_empleado,
            nombre: response.nombre,
            correo: response.correo,
...
exports.deleteEmpleados = async (id) => {
    ...
    try {
        await client.query('BEGIN');
        const response = (await client.query(querys_1.querysEmpleados.DELETE_empleados, [id])).rowCount > 0;
        await client.query('COMMIT');
        return response;
    }
    catch (e) {
...
//# sourceMappingURL=empleados.helper.js.map